...
### PAF (non-UCLA employees only)
 
1. If the Volunteer Research Assistnat is a non-UCLA employee that is leaving prior to their previously specified end date, lab manager must submit a PAF form to HR.
