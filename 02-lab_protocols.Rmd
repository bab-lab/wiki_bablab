...
#### Potential Lab Meeting Block Topics (in no particular order)
...
- Save any quote to (BAB/Lab/Finances/Purchasing/)
- Check Trello purchasing board for existing item
- If no existing item, create one and add description based on templates
- Fill out blank PAC form located in (BAB/Lab/Lab_protocols/Finances/Purchasing/)
- Save to (BAB/Lab/Finances/Purchasing)
...
For reimbursement: 
- Fill out a blank reimbursement form found in  (BAB/Lab/Lab_protocols/Finances/Reimbursement/)
- Save reimbursement form to (BAB/Lab/Finances/Reimbursement)
...
### Petty Cash
 ...
 - Fill out a blank IRB research payment request form (BAB/Lab/Lab_protocols/Finances/Petty_cash/)
...
### Using Trello
1. There are multiple lists on the Tasks Board! Doing, To-do, Later and Done. Depending on the task, simply move it to the right list once you progress with it.
