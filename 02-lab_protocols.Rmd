...
**Startup**: 4-404040-CB-69460 (Recharge ID: WSTV)

**R00**: 4-444040-CB-31447 (Recharge ID: Y7XE)
...
- Fill out blank PAC form located in (Dropbox/BAB/Lab/Lab_protocols/Finances/Purchasing/)
...
For reimbursement: 
- Fill out a blank reimbursement form found in  (Dropbox/BAB/Lab/Lab_protocols/Finances/Reimbursement/)
...
### Petty Cash
 ...
 - Fill out a blank IRB research payment request form (Dropbox/BAB/Lab/Lab_protocols/Finances/Petty_cash/)
...
1. Search up "Purchasing" board on Trello. It should be green.There are different tabs:
- **To Return**: items that will be returned
- **Maybe**: items that may be bought
- **To Order**: items to order/ buy
- **Sumbitted**: orders that have been submitted
...
- **Budget: Nonlogged** (this is by default)
- **Fund** (ask lab manager whether it's Startup or R00)
...
@[youtube](https://youtu.be/6YPngZ2cZto)
...
@[youtube](https://youtu.be/_Ry-SnJygy8)

### REDCap
#### Entering Instruments
@[youtube](https://youtu.be/aKdWA0ABOrU)
