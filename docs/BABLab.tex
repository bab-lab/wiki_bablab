...
\item
  ...
  \tightlist
  \item
    Type this line of code into your terminal and press enter (you may have to enter your password, if it looks like you aren't entering text, you really are, so just type and press enter)
  \end{itemize}
\end{enumerate}
