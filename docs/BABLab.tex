...
\item
  ...
  \item
    Read the \href{https://www.dropbox.com/s/t9atbx9d991gbwa/Lab_specific_biosafety_manual.pdf?dl=0}{Lab Specific Biosafety Manual} and sign off
  \item
...
\item
  Fill out blank PAC form located in (BAB/Lab/Lab\_protocols/Finances/Purchasing/)
\item
...
For reimbursement:
- Fill out a blank reimbursement form found in (BAB/Lab/Lab\_protocols/Finances/Reimbursement/)
...
\tightlist
\item
  Fill out a blank IRB research payment request form (BAB/Lab/Lab\_protocols/Finances/Petty\_cash/)
\item
