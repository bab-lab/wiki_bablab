...
\item
  ...
  \tightlist
  \item
    Lab Manager must consult with Bridget prior to hiring. Background checks must be run for all volunteers who are NOT UCLA students (\textasciitilde{}\$50 each). Unless otherwise specified, the Lab Manager should refer to the RA application pool within UCLA students.
  \item
