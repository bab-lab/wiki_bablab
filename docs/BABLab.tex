...
Before coming into the lab\ldots{}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Check-in with the Lab Manager to ensure you have met all of the requirements (e.g.~vaccination status, )
\end{enumerate}

Every time you come into the lab\ldots{}
...
\item
  Fill out the daily symptom monitoring and receive clearance prior to coming to the lab
\item
